# Löwenstein Prisma CPAP Data Viewer
...
| 1205 | Config Checksum | -123456789 | Signed int32 CRC |
...
| 1099 | Altitude Setting | 10 | Altitude index |
| 1100 | Altitude Value | 520 | Meters above sea level |
...
| 88 | 80 | Recording ID | `Recording start at Sat, 15.03.2025 22:35:12` |
| 168 | 8 | Start Date | `15.03.25` (DD.MM.YY) |
| 176 | 8 | Start Time | `22.35.12` (HH.MM.SS) |
...
```json
{"Type":"P3","SN":"0012345678","devid":"010","Day":"15.03.2025","Format":"v1.0","Offset":"0030"}
```
...
```xml
<stat u="250000" n1="248500" n2="47200" n4="4180"
      cd="2025-03-15_22:35:12" mv="2.4.2" v="3.2.1">
  <day d="2025-03-15" i="45">
    <rec m="2" v="12" t="81312-54,81420-7,...">
      <s i="100" v="0"/>
      <s i="101" v="4"/>
      ...
    </rec>
